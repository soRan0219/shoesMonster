							...
							<ul class="nav side-menu">
								<li><a><i class="fa fa-home"></i> 기준정보 관리 <span
									...
									<ul class="nav child_menu">
										...
										<li><a href="../performance/product.jsp">품목 관리</a></li>
										<li><a href="">원자재 관리</a></li>
										<li><a href="../performance/line.jsp">라인 관리</a></li>
									</ul></li>
								<li><a><i class="fa fa-desktop"></i> 생산 관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="../workorder/workOrderList.jsp">작업지시 관리</a></li>
								...
								<li><a><i class="fa fa-table"></i> 자재관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="../stock/stockList.jsp">재고 관리</a></li>
										<li><a href="../stock/raw_order.jsp">발주 관리</a></li>
										<li><a href="../stock/In_material.jsp">입고 관리</a></li>
										<li><a href="../stock/Out_material.jsp">출고 관리</a></li>
									</ul></li>
								<li><a><i class="fa fa-bar-chart-o"></i> 인사 관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="../person/empinfo.jsp">사원 관리</a></li>
										<li><a href="../person/management.jsp">권한 관리</a></li>
									</ul></li>
								<li><a><i class="fa fa-edit"></i> 영업 관리 <span
										class="fa fa-chevron-down"></span></a>
									<ul class="nav child_menu">
										<li><a href="../person/Clients.jsp">거래처 관리</a></li>
										<li><a href="../person/orderStatus.jsp">수주 현황</a></li>
										<li><a href="../person/orderManage.jsp">수주 관리</a></li>
										<li><a href="../performance/warehouse.jsp">창고 관리</a></li>
									</ul></li>
							</ul>
						</div>
						<div class="menu_section">
